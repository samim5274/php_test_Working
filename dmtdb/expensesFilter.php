...
<head>
    ...
    <title>Expense Filter - DMT</title>
</head>
<body>
...
<section> <form action="" method="POST">
    <div class="container">
        <div class="row mt-4">
            <h2 class="text-center mb-4">Expenses Filter Details</h2><br><br>
            <div class="col-md-3">
    ...
    <div class="container">
        ...
        <?php
            ...
            if(isset($_POST['btnFilter']))
            {
                ...
                $result = mysqli_query($conn,"SELECT * FROM `tb_expenses` WHERE Date BETWEEN '$startDate' AND '$endDate'");
